...
class Datatransformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            preprocessin_obj= self.get_data_tranformation_obj()
            ...
            input_features_train_arr= preprocessin_obj.fit_transform(input_features_train_df)
            input_features_test_arr= preprocessin_obj.transform(input_features_test_df)
